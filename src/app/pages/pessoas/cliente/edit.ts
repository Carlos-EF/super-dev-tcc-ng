...
export class ClienteEdit {
  ...
  dadosAdicionaisparaEditarForm = this.formBuilder.group({});
  ...
  alterarFormularioDadosAdicionais(tipo: string | null): void {
    if (tipo === "Interessado") {
      this.dadosAdicionaisparaEditarForm = this.criarFormInteressado();
    }
    else if (tipo === "Proprietário") {
      this.dadosAdicionaisparaEditarForm = this.criarFormProprietario();
    }
    else if (tipo === "Locatário") {
      this.dadosAdicionaisparaEditarForm = this.criarFormLocatario();
    }
  }
