...
@Component({
    ...
    <app-floating-configurator />
        <div class="bg-surface-50 dark:bg-surface-950 flex items-center justify-center min-h-screen min-w-screen overflow-hidden">
            <div class="border-primary border-1 p-4">
                <div class="flex flex-col items-center justify-center">
                    <div class="p-4">
                        <div class="w-full">
                            <div class="text-center mb-8">
                                ...
                                <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Bem-Vindo ao (Nome Projeto TCC :D)!</div>
                    ...
                    <div>
                        ...
                        <input pInputText id="email1" type="text" placeholder="DIgite seu e-mail." class="w-full mb-8" [(ngModel)]="email" />
                        
                        <label for="password1" class="block text-surface-900 dark:text-surface-0 font-medium text-xl mb-2">Senha:</label>
                        <p-password id="password1" [(ngModel)]="password" placeholder="Digite sua senha."  class="w-full mb-8" [toggleMask]="true" styleClass="mb-4" [fluid]="true" [feedback]="false"></p-password>
                        ...
                        <div class="flex items-center justify-between mt-2 mb-8 gap-8">
                            ...
                            <span class="font-medium no-underline ml-2 text-right cursor-pointer text-primary">Esqueçeu sua senha?</span>
                        </div>
